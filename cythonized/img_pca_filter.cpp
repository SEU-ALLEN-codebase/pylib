...
#define __PYX_HAVE__cythonized__img_pca_filter
#define __PYX_HAVE_API__cythonized__img_pca_filter
/* Early includes */
#include <string.h>
#include <stdio.h>
...
struct __pyx_opt_args_10cythonized_14img_pca_filter_img_pca_test;

/* "cythonized/img_pca_filter.pyx":12
...
/* Module declarations from 'cythonized.img_pca_filter' */
...
static PyArrayObject *__pyx_f_10cythonized_14img_pca_filter_img_pca_test(PyArrayObject *, int __pyx_skip_dispatch, struct __pyx_opt_args_10cythonized_14img_pca_filter_img_pca_test *__pyx_optional_args); /*proto*/
static double __pyx_f_10cythonized_14img_pca_filter_block_pca_test(__Pyx_memviewslice, int *, int *); /*proto*/
...
#define __Pyx_MODULE_NAME "cythonized.img_pca_filter"
extern int __pyx_module_is_main_cythonized__img_pca_filter;
int __pyx_module_is_main_cythonized__img_pca_filter = 0;

/* Implementation of 'cythonized.img_pca_filter' */
...
static PyObject *__pyx_pf_10cythonized_14img_pca_filter_img_pca_test(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_img, PyObject *__pyx_v_grid_radius, PyObject *__pyx_v_stride, float __pyx_v_sigma); /* proto */
...
static PyObject *__pyx_pw_10cythonized_14img_pca_filter_1img_pca_test(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_10cythonized_14img_pca_filter_img_pca_test(PyArrayObject *__pyx_v_img, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_10cythonized_14img_pca_filter_img_pca_test *__pyx_optional_args) {
  ...
  /* "cythonized/img_pca_filter.pyx":15
 *     cdef:
 *         int[3] grid
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":16
 *         int[3] grid
 *         int[3] gr = grid_radius
 *         int[3] st = stride             # <<<<<<<<<<<<<<
 *         int[3] dim = [img.shape[0], img.shape[1], img.shape[2]]
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":17
 *         int[3] gr = grid_radius
 *         int[3] st = stride
 *         int[3] dim = [img.shape[0], img.shape[1], img.shape[2]]             # <<<<<<<<<<<<<<
 *         int i, j, k
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":19
 *         int[3] dim = [img.shape[0], img.shape[1], img.shape[2]]
 *         int i, j, k
 *         int[3] ct = stride             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":21
 *         int[3] ct = stride
 * 
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         grid[i] = dim[i] / st[i]
 ...
 */
  for (__pyx_t_3 = 0; __pyx_t_3 < 3; __pyx_t_3+=1) {
    ...
    /* "cythonized/img_pca_filter.pyx":22
 * 
 *     for i in range(3):
 *         grid[i] = dim[i] / st[i]             # <<<<<<<<<<<<<<
 *         assert grid[i] > 0
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":23
 *     for i in range(3):
 *         grid[i] = dim[i] / st[i]
 *         assert grid[i] > 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":25
 *         assert grid[i] > 0
 * 
 *     cdef np.ndarray[np.float32_t, ndim=3] g = np.zeros(grid, dtype=np.float32)             # <<<<<<<<<<<<<<
 *     ct[0] = st[0]
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":26
 * 
 *     cdef np.ndarray[np.float32_t, ndim=3] g = np.zeros(grid, dtype=np.float32)
 *     ct[0] = st[0]             # <<<<<<<<<<<<<<
 *     for i in range(grid[0]):
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":27
 *     cdef np.ndarray[np.float32_t, ndim=3] g = np.zeros(grid, dtype=np.float32)
 *     ct[0] = st[0]
 *     for i in range(grid[0]):             # <<<<<<<<<<<<<<
 *         ct[1] = st[1]
 ...
 */
  ...
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    ...
    /* "cythonized/img_pca_filter.pyx":28
 *     ct[0] = st[0]
 *     for i in range(grid[0]):
 *         ct[1] = st[1]             # <<<<<<<<<<<<<<
 *         for j in range(grid[1]):
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":29
 *     for i in range(grid[0]):
 *         ct[1] = st[1]
 *         for j in range(grid[1]):             # <<<<<<<<<<<<<<
 *             ct[2] = st[2]
 ...
 */
    ...
    for (__pyx_t_14 = 0; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      ...
      /* "cythonized/img_pca_filter.pyx":30
 *         ct[1] = st[1]
 *         for j in range(grid[1]):
 *             ct[2] = st[2]             # <<<<<<<<<<<<<<
 *             for k in range(grid[2]):
 ...
 */
      ...
      /* "cythonized/img_pca_filter.pyx":31
 *         for j in range(grid[1]):
 *             ct[2] = st[2]
 *             for k in range(grid[2]):             # <<<<<<<<<<<<<<
 *                 g[i, j, k] = block_pca_test(img, ct, gr)
 ...
 */
      ...
      for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
        ...
        /* "cythonized/img_pca_filter.pyx":32
 *             ct[2] = st[2]
 *             for k in range(grid[2]):
 *                 g[i, j, k] = block_pca_test(img, ct, gr)             # <<<<<<<<<<<<<<
 *                 ct[2] += st[2]
 ...
 */
        ...
        *__Pyx_BufPtrStrided3d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_g.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_g.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_g.diminfo[1].strides, __pyx_t_21, __pyx_pybuffernd_g.diminfo[2].strides) = __pyx_f_10cythonized_14img_pca_filter_block_pca_test(__pyx_t_18, __pyx_v_ct, __pyx_v_gr);
        __PYX_XDEC_MEMVIEW(&__pyx_t_18, 1);
        __pyx_t_18.memview = NULL;
        __pyx_t_18.data = NULL;

        /* "cythonized/img_pca_filter.pyx":33
 *             for k in range(grid[2]):
 *                 g[i, j, k] = block_pca_test(img, ct, gr)
 *                 ct[2] += st[2]             # <<<<<<<<<<<<<<
 *             ct[1] += st[1]
 ...
 */
      ...
      /* "cythonized/img_pca_filter.pyx":34
 *                 g[i, j, k] = block_pca_test(img, ct, gr)
 *                 ct[2] += st[2]
 *             ct[1] += st[1]             # <<<<<<<<<<<<<<
 *         ct[0] += st[0]
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":35
 *                 ct[2] += st[2]
 *             ct[1] += st[1]
 *         ct[0] += st[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":37
 *         ct[0] += st[0]
 * 
 *     g = gaussian(g, sigma)             # <<<<<<<<<<<<<<
 *     i, j, k = g.shape[:3]
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":38
 * 
 *     g = gaussian(g, sigma)
 *     i, j, k = g.shape[:3]             # <<<<<<<<<<<<<<
 *     out = np.empty((i, st[0], j, st[1], k, st[2]), np.float32)
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":39
 *     g = gaussian(g, sigma)
 *     i, j, k = g.shape[:3]
 *     out = np.empty((i, st[0], j, st[1], k, st[2]), np.float32)             # <<<<<<<<<<<<<<
 *     out[...] = g[:, None, :, None, :, None]
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":40
 *     i, j, k = g.shape[:3]
 *     out = np.empty((i, st[0], j, st[1], k, st[2]), np.float32)
 *     out[...] = g[:, None, :, None, :, None]             # <<<<<<<<<<<<<<
 *     i, j, k = img.shape[:3]
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":41
 *     out = np.empty((i, st[0], j, st[1], k, st[2]), np.float32)
 *     out[...] = g[:, None, :, None, :, None]
 *     i, j, k = img.shape[:3]             # <<<<<<<<<<<<<<
 *     return out.reshape(i, j, k)
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":42
 *     out[...] = g[:, None, :, None, :, None]
 *     i, j, k = img.shape[:3]
 *     return out.reshape(i, j, k)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("cythonized.img_pca_filter.img_pca_test", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_g.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_10cythonized_14img_pca_filter_1img_pca_test(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_10cythonized_14img_pca_filter_1img_pca_test(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_10cythonized_14img_pca_filter_img_pca_test(__pyx_self, __pyx_v_img, __pyx_v_grid_radius, __pyx_v_stride, __pyx_v_sigma);
...
static PyObject *__pyx_pf_10cythonized_14img_pca_filter_img_pca_test(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_img, PyObject *__pyx_v_grid_radius, PyObject *__pyx_v_stride, float __pyx_v_sigma) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_img;
  __Pyx_Buffer __pyx_pybuffer_img;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_10cythonized_14img_pca_filter_img_pca_test __pyx_t_2;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("img_pca_test", 0);
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_10cythonized_14img_pca_filter_img_pca_test(__pyx_v_img, 0, &__pyx_t_2)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 12, __pyx_L1_error)
...
/* "cythonized/img_pca_filter.pyx":48
 * @cython.wraparound(False)
 * @cython.cdivision(True)
...
static double __pyx_f_10cythonized_14img_pca_filter_block_pca_test(__Pyx_memviewslice __pyx_v_img, int *__pyx_v_c, int *__pyx_v_r) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_k;
  int __pyx_v_count;
  ...
  /* "cythonized/img_pca_filter.pyx":50
 * cdef double block_pca_test(unsigned short[:, :, :] img, int[3] c, int[3] r):
 *     cdef:
 *         int i, j, k, count = 1             # <<<<<<<<<<<<<<
 *         int[3] start
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":55
 *         double[3] r2
 * 
 *     for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_1 = 0; __pyx_t_1 < 3; __pyx_t_1+=1) {
    ...
    /* "cythonized/img_pca_filter.pyx":56
 * 
 *     for i in range(3):
 *         start[i] = max(c[i] - r[i], 0)             # <<<<<<<<<<<<<<
 *         end[i] = min(c[i] + r[i] + 1, img.shape[i])
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":57
 *     for i in range(3):
 *         start[i] = max(c[i] - r[i], 0)
 *         end[i] = min(c[i] + r[i] + 1, img.shape[i])             # <<<<<<<<<<<<<<
 *         count *= end[i] - start[i]
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":58
 *         start[i] = max(c[i] - r[i], 0)
 *         end[i] = min(c[i] + r[i] + 1, img.shape[i])
 *         count *= end[i] - start[i]             # <<<<<<<<<<<<<<
 *         r2[i] = (r[i] + 1) * (r[i] + 1)
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":59
 *         end[i] = min(c[i] + r[i] + 1, img.shape[i])
 *         count *= end[i] - start[i]
 *         r2[i] = (r[i] + 1) * (r[i] + 1)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":63
 *     # center of mass
 *     cdef:
 *         double[3] ct = [0, 0, 0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":64
 *     cdef:
 *         double[3] ct = [0, 0, 0]
 *         double mv, i2, j2, k2, tmpd, s = 0, sss = 0, w             # <<<<<<<<<<<<<<
 *     count = 0
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":65
 *         double[3] ct = [0, 0, 0]
 *         double mv, i2, j2, k2, tmpd, s = 0, sss = 0, w
 *     count = 0             # <<<<<<<<<<<<<<
 *     for i in range(start[0], end[0]):
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":66
 *         double mv, i2, j2, k2, tmpd, s = 0, sss = 0, w
 *     count = 0
 *     for i in range(start[0], end[0]):             # <<<<<<<<<<<<<<
 *         for j in range(start[1], end[1]):
 ...
 */
  ...
  for (__pyx_t_8 = (__pyx_v_start[0]); __pyx_t_8 < __pyx_t_3; __pyx_t_8+=1) {
    ...
    /* "cythonized/img_pca_filter.pyx":67
 *     count = 0
 *     for i in range(start[0], end[0]):
 *         for j in range(start[1], end[1]):             # <<<<<<<<<<<<<<
 *             for k in range(start[2], end[2]):
 ...
 */
    ...
    for (__pyx_t_11 = (__pyx_v_start[1]); __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      ...
      /* "cythonized/img_pca_filter.pyx":68
 *     for i in range(start[0], end[0]):
 *         for j in range(start[1], end[1]):
 *             for k in range(start[2], end[2]):             # <<<<<<<<<<<<<<
 *                 w = img[i, j, k]
 ...
 */
      ...
      for (__pyx_t_14 = (__pyx_v_start[2]); __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        ...
        /* "cythonized/img_pca_filter.pyx":69
 *         for j in range(start[1], end[1]):
 *             for k in range(start[2], end[2]):
 *                 w = img[i, j, k]             # <<<<<<<<<<<<<<
 *                 s += w
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":70
 *             for k in range(start[2], end[2]):
 *                 w = img[i, j, k]
 *                 s += w             # <<<<<<<<<<<<<<
 *                 w = w*w*w
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":71
 *                 w = img[i, j, k]
 *                 s += w
 *                 w = w*w*w             # <<<<<<<<<<<<<<
 *                 sss += w
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":72
 *                 s += w
 *                 w = w*w*w
 *                 sss += w             # <<<<<<<<<<<<<<
 *                 ct[0] += w * i
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":73
 *                 w = w*w*w
 *                 sss += w
 *                 ct[0] += w * i             # <<<<<<<<<<<<<<
 *                 ct[1] += w * j
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":74
 *                 sss += w
 *                 ct[0] += w * i
 *                 ct[1] += w * j             # <<<<<<<<<<<<<<
 *                 ct[2] += w * k
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":75
 *                 ct[0] += w * i
 *                 ct[1] += w * j
 *                 ct[2] += w * k             # <<<<<<<<<<<<<<
 *                 count += 1
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":76
 *                 ct[1] += w * j
 *                 ct[2] += w * k
 *                 count += 1             # <<<<<<<<<<<<<<
 *     if s > 0:
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":77
 *                 ct[2] += w * k
 *                 count += 1
 *     if s > 0:             # <<<<<<<<<<<<<<
 *         ct[0] /= sss
 ...
 */
  ...
  if (__pyx_t_18) {
    ...
    /* "cythonized/img_pca_filter.pyx":78
 *                 count += 1
 *     if s > 0:
 *         ct[0] /= sss             # <<<<<<<<<<<<<<
 *         ct[1] /= sss
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":79
 *     if s > 0:
 *         ct[0] /= sss
 *         ct[1] /= sss             # <<<<<<<<<<<<<<
 *         ct[2] /= sss
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":80
 *         ct[0] /= sss
 *         ct[1] /= sss
 *         ct[2] /= sss             # <<<<<<<<<<<<<<
 *         mv = s / count
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":81
 *         ct[1] /= sss
 *         ct[2] /= sss
 *         mv = s / count             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":83
 *         mv = s / count
 *     else:
 *         return 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":87
 *     # pca
 *     cdef:
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":88
 *     cdef:
 *         double cc11 = 0, cc12 = 0, cc13 = 0, cc22 = 0, cc23 = 0, cc33 = 0, ns = 0
 *         double[3] df = [0, 0, 0]             # <<<<<<<<<<<<<<
 *     for i in range(start[0], end[0]):
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":89
 *         double cc11 = 0, cc12 = 0, cc13 = 0, cc22 = 0, cc23 = 0, cc33 = 0, ns = 0
 *         double[3] df = [0, 0, 0]
 *     for i in range(start[0], end[0]):             # <<<<<<<<<<<<<<
 *         df[0] = (i - ct[0]) / r[0]
 ...
 */
  ...
  for (__pyx_t_8 = (__pyx_v_start[0]); __pyx_t_8 < __pyx_t_3; __pyx_t_8+=1) {
    ...
    /* "cythonized/img_pca_filter.pyx":90
 *         double[3] df = [0, 0, 0]
 *     for i in range(start[0], end[0]):
 *         df[0] = (i - ct[0]) / r[0]             # <<<<<<<<<<<<<<
 *         for j in range(start[1], end[1]):
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":91
 *     for i in range(start[0], end[0]):
 *         df[0] = (i - ct[0]) / r[0]
 *         for j in range(start[1], end[1]):             # <<<<<<<<<<<<<<
 *             df[1] = (j - ct[1]) / r[1]
 ...
 */
    ...
    for (__pyx_t_11 = (__pyx_v_start[1]); __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      ...
      /* "cythonized/img_pca_filter.pyx":92
 *         df[0] = (i - ct[0]) / r[0]
 *         for j in range(start[1], end[1]):
 *             df[1] = (j - ct[1]) / r[1]             # <<<<<<<<<<<<<<
 *             for k in range(start[2], end[2]):
 ...
 */
      ...
      /* "cythonized/img_pca_filter.pyx":93
 *         for j in range(start[1], end[1]):
 *             df[1] = (j - ct[1]) / r[1]
 *             for k in range(start[2], end[2]):             # <<<<<<<<<<<<<<
 *                 df[2] = (k - ct[2]) / r[2]
 ...
 */
      ...
      for (__pyx_t_14 = (__pyx_v_start[2]); __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
        ...
        /* "cythonized/img_pca_filter.pyx":94
 *             df[1] = (j - ct[1]) / r[1]
 *             for k in range(start[2], end[2]):
 *                 df[2] = (k - ct[2]) / r[2]             # <<<<<<<<<<<<<<
 *                 w = img[i, j, k]
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":95
 *             for k in range(start[2], end[2]):
 *                 df[2] = (k - ct[2]) / r[2]
 *                 w = img[i, j, k]             # <<<<<<<<<<<<<<
 *                 if w > 0:
 ...
 */
        ...
        /* "cythonized/img_pca_filter.pyx":96
 *                 df[2] = (k - ct[2]) / r[2]
 *                 w = img[i, j, k]
 *                 if w > 0:             # <<<<<<<<<<<<<<
 *                     w = w*w*w
 ...
 */
        ...
        if (__pyx_t_18) {
          ...
          /* "cythonized/img_pca_filter.pyx":97
 *                 w = img[i, j, k]
 *                 if w > 0:
 *                     w = w*w*w             # <<<<<<<<<<<<<<
 *                     cc11 += w * df[0] * df[0]
 ...
 */
          ...
          /* "cythonized/img_pca_filter.pyx":98
 *                 if w > 0:
 *                     w = w*w*w
 *                     cc11 += w * df[0] * df[0]             # <<<<<<<<<<<<<<
 *                     cc12 += w * df[0] * df[1]
 ...
 */
          ...
          /* "cythonized/img_pca_filter.pyx":99
 *                     w = w*w*w
 *                     cc11 += w * df[0] * df[0]
 *                     cc12 += w * df[0] * df[1]             # <<<<<<<<<<<<<<
 *                     cc13 += w * df[0] * df[2]
 ...
 */
          ...
          /* "cythonized/img_pca_filter.pyx":100
 *                     cc11 += w * df[0] * df[0]
 *                     cc12 += w * df[0] * df[1]
 *                     cc13 += w * df[0] * df[2]             # <<<<<<<<<<<<<<
 *                     cc22 += w * df[1] * df[1]
 ...
 */
          ...
          /* "cythonized/img_pca_filter.pyx":101
 *                     cc12 += w * df[0] * df[1]
 *                     cc13 += w * df[0] * df[2]
 *                     cc22 += w * df[1] * df[1]             # <<<<<<<<<<<<<<
 *                     cc23 += w * df[1] * df[2]
 ...
 */
          ...
          /* "cythonized/img_pca_filter.pyx":102
 *                     cc13 += w * df[0] * df[2]
 *                     cc22 += w * df[1] * df[1]
 *                     cc23 += w * df[1] * df[2]             # <<<<<<<<<<<<<<
 *                     cc33 += w * df[2] * df[2]
 ...
 */
          ...
          /* "cythonized/img_pca_filter.pyx":103
 *                     cc22 += w * df[1] * df[1]
 *                     cc23 += w * df[1] * df[2]
 *                     cc33 += w * df[2] * df[2]             # <<<<<<<<<<<<<<
 *                     ns += w
 ...
 */
          ...
          /* "cythonized/img_pca_filter.pyx":104
 *                     cc23 += w * df[1] * df[2]
 *                     cc33 += w * df[2] * df[2]
 *                     ns += w             # <<<<<<<<<<<<<<
 *     cc11 /= ns
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":105
 *                     cc33 += w * df[2] * df[2]
 *                     ns += w
 *     cc11 /= ns             # <<<<<<<<<<<<<<
 *     cc12 /= ns
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":106
 *                     ns += w
 *     cc11 /= ns
 *     cc12 /= ns             # <<<<<<<<<<<<<<
 *     cc13 /= ns
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":107
 *     cc11 /= ns
 *     cc12 /= ns
 *     cc13 /= ns             # <<<<<<<<<<<<<<
 *     cc22 /= ns
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":108
 *     cc12 /= ns
 *     cc13 /= ns
 *     cc22 /= ns             # <<<<<<<<<<<<<<
 *     cc23 /= ns
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":109
 *     cc13 /= ns
 *     cc22 /= ns
 *     cc23 /= ns             # <<<<<<<<<<<<<<
 *     cc33 /= ns
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":110
 *     cc22 /= ns
 *     cc23 /= ns
 *     cc33 /= ns             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float64_t, ndim = 2] cov = np.zeros([3, 3], dtype=np.float)
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":111
 *     cc23 /= ns
 *     cc33 /= ns
 *     cdef np.ndarray[np.float64_t, ndim = 2] cov = np.zeros([3, 3], dtype=np.float)             # <<<<<<<<<<<<<<
 *     cov[0, 0] = cc11
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":112
 *     cc33 /= ns
 *     cdef np.ndarray[np.float64_t, ndim = 2] cov = np.zeros([3, 3], dtype=np.float)
 *     cov[0, 0] = cc11             # <<<<<<<<<<<<<<
 *     cov[1, 1] = cc22
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_cov.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_cov.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_cov.diminfo[1].strides) = __pyx_v_cc11;
  ...
  /* "cythonized/img_pca_filter.pyx":113
 *     cdef np.ndarray[np.float64_t, ndim = 2] cov = np.zeros([3, 3], dtype=np.float)
 *     cov[0, 0] = cc11
 *     cov[1, 1] = cc22             # <<<<<<<<<<<<<<
 *     cov[2, 2] = cc33
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_cov.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_cov.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_cov.diminfo[1].strides) = __pyx_v_cc22;
  ...
  /* "cythonized/img_pca_filter.pyx":114
 *     cov[0, 0] = cc11
 *     cov[1, 1] = cc22
 *     cov[2, 2] = cc33             # <<<<<<<<<<<<<<
 *     cov[0, 1] = cc12
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_cov.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_cov.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_cov.diminfo[1].strides) = __pyx_v_cc33;
  ...
  /* "cythonized/img_pca_filter.pyx":115
 *     cov[1, 1] = cc22
 *     cov[2, 2] = cc33
 *     cov[0, 1] = cc12             # <<<<<<<<<<<<<<
 *     cov[0, 2] = cc13
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_cov.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_cov.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_cov.diminfo[1].strides) = __pyx_v_cc12;
  ...
  /* "cythonized/img_pca_filter.pyx":116
 *     cov[2, 2] = cc33
 *     cov[0, 1] = cc12
 *     cov[0, 2] = cc13             # <<<<<<<<<<<<<<
 *     cov[1, 2] = cc23
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_cov.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_cov.diminfo[0].strides, __pyx_t_16, __pyx_pybuffernd_cov.diminfo[1].strides) = __pyx_v_cc13;
  ...
  /* "cythonized/img_pca_filter.pyx":117
 *     cov[0, 1] = cc12
 *     cov[0, 2] = cc13
 *     cov[1, 2] = cc23             # <<<<<<<<<<<<<<
 *     try:
 ...
 */
  ...
  *__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float64_t *, __pyx_pybuffernd_cov.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_cov.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_cov.diminfo[1].strides) = __pyx_v_cc23;
  ...
  /* "cythonized/img_pca_filter.pyx":118
 *     cov[0, 2] = cc13
 *     cov[1, 2] = cc23
 *     try:             # <<<<<<<<<<<<<<
 *         val = eigvalsh(cov, 'U')
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "cythonized/img_pca_filter.pyx":119
 *     cov[1, 2] = cc23
 *     try:
 *         val = eigvalsh(cov, 'U')             # <<<<<<<<<<<<<<
 *         return (val[2] - val[1]) / (val[2] + val[1]) * (val[2] - val[0]) / (val[2] + val[0])
 ...
 */
      ...
      /* "cythonized/img_pca_filter.pyx":120
 *     try:
 *         val = eigvalsh(cov, 'U')
 *         return (val[2] - val[1]) / (val[2] + val[1]) * (val[2] - val[0]) / (val[2] + val[0])             # <<<<<<<<<<<<<<
 *     except:
 ...
 */
    ...
    /* "cythonized/img_pca_filter.pyx":121
 *         val = eigvalsh(cov, 'U')
 *         return (val[2] - val[1]) / (val[2] + val[1]) * (val[2] - val[0]) / (val[2] + val[0])
 *     except:             # <<<<<<<<<<<<<<
 *         return 0
 */
    /*except:*/ {
      __Pyx_AddTraceback("cythonized.img_pca_filter.block_pca_test", __pyx_clineno, __pyx_lineno, __pyx_filename);
      if (__Pyx_GetException(&__pyx_t_24, &__pyx_t_22, &__pyx_t_21) < 0) __PYX_ERR(0, 121, __pyx_L21_except_error)
      __Pyx_GOTREF(__pyx_t_24);
      __Pyx_GOTREF(__pyx_t_22);
      __Pyx_GOTREF(__pyx_t_21);

      /* "cythonized/img_pca_filter.pyx":122
 *         return (val[2] - val[1]) / (val[2] + val[1]) * (val[2] - val[0]) / (val[2] + val[0])
 *     except:
 *         return 0             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_WriteUnraisable("cythonized.img_pca_filter.block_pca_test", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_cov.rcbuffer->pybuffer);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cythonized.img_pca_filter.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cythonized.img_pca_filter.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cythonized.img_pca_filter.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cythonized.img_pca_filter._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"img_pca_test", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10cythonized_14img_pca_filter_1img_pca_test, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_cythonized__img_pca_filter) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cythonized.img_pca_filter")) {
      if (unlikely(PyDict_SetItemString(modules, "cythonized.img_pca_filter", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "cythonized/img_pca_filter.pyx":3
 * import cython
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":5
 * import numpy as np
 * cimport numpy as np
 * from numpy.linalg import eigvalsh             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":6
 * cimport numpy as np
 * from numpy.linalg import eigvalsh
 * from skimage.filters import gaussian             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "cythonized/img_pca_filter.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * cimport cython
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cythonized.img_pca_filter", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cythonized.img_pca_filter");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
