...
class BaseTracer(object):
    ...
    def __init__(self, vaa3d_path=None, env=None, timeout=None):
...
class APP1(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(APP1, self).__init__(vaa3d_path, env)
...
class APP2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(APP2, self).__init__(vaa3d_path, env)
...
class APP2_NEW1(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(APP2_NEW1, self).__init__(vaa3d_path, env)
...
class APP2_NEW2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(APP2_NEW2, self).__init__(vaa3d_path, env)
...
class APP2_NEW3(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(APP2_NEW3, self).__init__(vaa3d_path, env)
...
class MOST(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(MOST, self).__init__(vaa3d_path, env)
...
class NEUTUBE(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(NEUTUBE, self).__init__(vaa3d_path, env)
...
class SNAKE(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(SNAKE, self).__init__(vaa3d_path, env)
...
class SimpleTracing1(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(SimpleTracing1, self).__init__(vaa3d_path, env)
...
class SimpleTracing2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(SimpleTracing2, self).__init__(vaa3d_path, env)
...
class SimpleTracing3(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(SimpleTracing3, self).__init__(vaa3d_path, env)
...
class TreMap(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(TreMap, self).__init__(vaa3d_path, env)
...
class MST(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(MST, self).__init__(vaa3d_path, env)
...
class NeuroGPSTree(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(NeuroGPSTree, self).__init__(vaa3d_path, env)
...
class NeuroGPSTree2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(NeuroGPSTree2, self).__init__(vaa3d_path, env)
...
class FMST(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(FMST, self).__init__(vaa3d_path, env)
...
class MeanShift(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(MeanShift, self).__init__(vaa3d_path, env)
...
class CWlab11(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(CWlab11, self).__init__(vaa3d_path, env)
...
class LCM_boost(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(LCM_boost, self).__init__(vaa3d_path, env)
...
class LCM_boost_2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(LCM_boost_2, self).__init__(vaa3d_path, env)
...
class LCM_boost_3(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(LCM_boost_3, self).__init__(vaa3d_path, env)
...
class NeuroStalker(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(NeuroStalker, self).__init__(vaa3d_path, env)
...
class nctuTW(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(nctuTW, self).__init__(vaa3d_path, env)
...
class tips_GD(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(tips_GD, self).__init__(vaa3d_path, env)
...
class SimpleAxisAnalyzer(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(SimpleAxisAnalyzer, self).__init__(vaa3d_path, env)
...
class NeuronChaser(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(NeuronChaser, self).__init__(vaa3d_path, env)
...
class NeuronChaser2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(NeuronChaser2, self).__init__(vaa3d_path, env)
...
class smartTracing(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(smartTracing, self).__init__(vaa3d_path, env)
...
class neutu_autotrace(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(neutu_autotrace, self).__init__(vaa3d_path, env)
...
class Advantra(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(Advantra, self).__init__(vaa3d_path, env)
...
class Advantra2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(Advantra2, self).__init__(vaa3d_path, env)
...
class RegMST(BaseTracer):
    def __init__(self, vaa3d_path=None, p0=21, p1=200):
        super(RegMST, self).__init__(vaa3d_path, env)
        self.p0 = p0
        self.p1 = p1
...
class EnsembleNeuronTracer(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(EnsembleNeuronTracer, self).__init__(vaa3d_path, env)
...
class EnsembleNeuronTracerV2n(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(EnsembleNeuronTracerV2n, self).__init__(vaa3d_path, env)
...
class EnsembleNeuronTracerV2s(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(EnsembleNeuronTracerV2s, self).__init__(vaa3d_path, env)
...
class threeDTraceSWC(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(threeDTraceSWC, self).__init__(vaa3d_path, env)
...
class threeDTraceSWC2(BaseTracer):
    def __init__(self, vaa3d_path=None, env=None):
        super(threeDTraceSWC2, self).__init__(vaa3d_path, env)
...
class TracingRunner(object):
    def __init__(self, vaa3d_path=None, tracers=None, env=None):
        self.vaa3d_path = vaa3d_path
        self.tracers = tracers
        self.tracers_dict = self._init_tracers(tracers, vaa3d_path, env=env)

    @staticmethod
    def _init_tracers(tracers, vaa3d_path, env=None):
        print(f'Initializing {len(tracers)} tracers: {tracers}')
        tracers_dict = {}
        gvs = globals()
        for tracer in tracers:
            cls = gvs[tracer](vaa3d_path=vaa3d_path, env=env)
    ...
    def run_in_tracer_file(self, imgdir, outdir, nprocessors, with_subdir, file_ext, distinguish_str, debug=False):
        # initialize task list
        args_list = []
        for tracer in self.tracers:
            # create folders if not exists
